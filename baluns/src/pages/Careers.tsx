    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Button className="bg-orange-primary hover:bg-orange-secondary text-white px-8 py-3 rounded-md">
                Open positions ↓
              </Button>
            </div>
            <div className="relative">
              <div className="relative bg-gradient-to-br from-purple-600 to-purple-800 rounded-full w-96 h-96 mx-auto flex items-center justify-center">
                ...
                {/* Floating avatars */}
                <div className="absolute top-12 right-8 w-12 h-12 bg-green-400 rounded-full"></div>
                <div className="absolute top-32 right-4 w-8 h-8 bg-orange-400 rounded-full"></div>
                <div className="absolute bottom-32 right-12 w-10 h-10 bg-blue-400 rounded-full"></div>
                <div className="absolute bottom-16 left-8 w-12 h-12 bg-red-400 rounded-full"></div>
                <div className="absolute top-24 left-4 w-8 h-8 bg-gray-400 rounded-full"></div>
                <div className="absolute right-24 top-8 w-6 h-6 bg-blue-300 rounded-full"></div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="lg:col-span-1">
              ...
              <div className="mt-8 text-white">
                <p className="mb-4">
                  ...
                  your desired position here, please send us your LinkedIn profile and 
                  give us your contact information. We will be in touch.
                </p>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-lg p-8">
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-12 text-center">
                  ...
                  <p className="text-sm text-gray-400">Formats accepted are .doc and .pdf</p>
                </div>
                <div className="flex justify-end gap-4 mt-6">
                  <Button variant="outline">Cancel</Button>
                  <Button className="bg-orange-primary hover:bg-orange-secondary">Apply</Button>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-gray-100 py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-6 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-12">Employee Feedback</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {reviews.map((review, index) => (
              <div key={index} className="bg-white rounded-lg p-6 text-left">
                ...
                <p className="text-sm text-gray-500 mb-2">{review.daysAgo} days ago</p>
